...
class RewardsMenu extends BaseMenu
{
    ...
    public function init()
    {
        ...
        $this->addItemGroup(array(
            'id' => 'account',
            'label' => Yii::t('UserModule.widgets_RewardsMenuWidget', '<strong>Rewards</strong> Menus'),
            'sortOrder' => 100,
        ));

        $this->addItem(array(
            'label' => Yii::t('UserModule.widgets_RewardsMenuWidget', 'Profile'),
        ...
        $this->addItem(array(
            'label' => Yii::t('UserModule.account', 'Notifications123'),
        ...
        $this->addItem(array(
            'label' => Yii::t('UserModule.widgets_RewardsMenuWidget', 'Settings'),
        ...
        $this->addItem(array(
            'label' => Yii::t('UserModule.widgets_RewardsMenuWidget', 'Security'),
